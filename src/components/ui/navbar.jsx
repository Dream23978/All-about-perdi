...
const defaultNavigationLinks = [
  { href: "#", label: "Tentang", active: true },
  { href: "#judul-lagu", label: "Musik Favorit" },
  { href: "#momen", label: "Momen Favorit" },
  { href: "#ngoding", label: "ngoding" },
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-6">
            <button
              ...
              <span className="hidden font-bold text-xl sm:inline-block">Ferdian</span>
            </button>
            {/* Navigation menu */}
            {!isMobile && (
